...
export default function SearchPlayer() {
  ...
  // Pick a valid Clash Royale player tag for the demo
  const placeholder = "#9RQ8YRYQL";

  const onSearch = () => {
    const cleanTag = (tag.trim() || placeholder).toUpperCase(); // fallback to placeholder if empty
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={styles.tip}>
          Tip: We will automatically add the # if you forget it.
        </Text>
      </View>
    </KeyboardAvoidingView>
  );
